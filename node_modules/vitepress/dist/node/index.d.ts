...
import { LocaleSpecificConfig, LocaleConfig, Awaitable, SSGContext, HeadConfig, PageData, SiteData, DefaultTheme, Header } from '../../types/shared.js';
...
interface SiteConfig<ThemeConfig = any> extends Pick<UserConfig, 'markdown' | 'vue' | 'vite' | 'shouldPreload' | 'mpa' | 'lastUpdated' | 'ignoreDeadLinks' | 'cleanUrls' | 'useWebFonts' | 'postRender' | 'buildEnd' | 'transformHead' | 'transformHtml' | 'transformPageData'> {
    root: string;
    srcDir: string;
...
export { MarkdownEnv, MarkdownOptions, MarkdownRenderer, RawConfigExports, ServeOptions, SiteConfig, ThemeOptions, TransformContext, UserConfig, build, createMarkdownRenderer, createServer, defineConfig, defineConfigWithTheme, resolveConfig, resolveSiteData, serve };
