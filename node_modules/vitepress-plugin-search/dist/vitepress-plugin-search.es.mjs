...
const replaceMdSyntax = (e) => e.replace(/\[(.*?)\]\(.*?\)/g, "$1").replace(/(\*+)(\s*\b)([^\*]*)(\b\s*)(\*+)/gm, "$3"), getFileList = async (e) => {
  let n = [];
  const i = await readdir(e, { withFileTypes: !0 });
  for (const s of i)
    s.isDirectory() && s.name != "node_modules" ? n = [...n, ...await getFileList(`${e}/${s.name}`)] : s.name.endsWith(".md") && n.push(`${e}/${s.name}`);
  return n;
}, removeFrontMatter = (e) => e.replace(/^---(.|\W)*?---/, ""), removeScriptTag = (e) => e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, "").trim(), removeStyleTag = (e) => e.replace(/<style\b[^<]*(?:(?!<\/style>)<[^<]*)*<\/style>/gi, "").trim(), processMdFiles = async (e) => {
  rootPath = e;
  let n = await getFileList(e), i = [];
  for (let s = 0; s < n.length; s++) {
    const r = n[s];
    let o = await readFile(r, { encoding: "utf8" }), l = removeStyleTag(
      removeScriptTag(replaceMdSyntax(removeFrontMatter(o)))
    );
    i.push({ content: l, path: r });
  }
...
`), path: n };
  ...
  let i, s, r = e.anchor;
  (i = /\{(.*?)\}/m.exec(e.anchor)) !== null && (r = i[0], s = e.anchor.replace(/\{(.*?)\}/m, "")), r = slugify(r), r[0] == "#" && (r = r.replace("#", ""));
  let o = e.path.replace(rootPath + "/", "").replace("md", "html");
  return n.includes(".0") || (o += `#${slugify(r)}`), s ? {
    id: n,
    link: o,
    b: e.content,
    a: r,
  ...
  const i = await processMdFiles(e), s = [];
  if (i !== void 0)
...
var commonjsGlobal = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, flexsearch_bundleExports = {}, flexsearch_bundle = {
  get exports() {
...
(function(module) {
  (function _f(self) {
    ...
    function fa(e, n) {
      const i = Object.keys(e), s = i.length, r = [];
      let o = "", l = 0;
      for (let h = 0, f, p; h < s; h++)
        f = i[h], (p = e[f]) ? (r[l++] = F(n ? "(?!\\b)" + f + "(\\b|_)" : f), r[l++] = p) : o += (o ? "|" : "") + f;
      return o && (r[l++] = F(n ? "(?!\\b)(" + o + ")(\\b|_)" : "(" + o + ")"), r[l] = ""), r;
    }
    function E(e, n) {
      for (let i = 0, s = n.length; i < s && (e = e.replace(n[i], n[i + 1]), e); i += 2)
        ;
      return e;
    }
    function F(e) {
    ...
    function na(e, n) {
      ...
      for (let o = 0, l; o < n.length; o++) {
        ...
        for (let h = 0, f; h < l.length; h++)
          f = l[h], i[f] && !s[f] && (s[f] = 1, r[r.length] = f);
      }
      return r;
    }
    function J(e) {
    ...
    function oa(e, n, i) {
      ...
      return s || (s = this.search(e, n, i), this.cache.set(e, s)), s;
    }
    ...
    function ra(e, n, i, s, r, o, l) {
      setTimeout(function() {
        const h = e(i ? i + "." + s : s, JSON.stringify(l));
        h && h.then ? h.then(function() {
          n.export(e, n, i, r, o + 1);
        }) : n.export(e, n, i, r, o + 1);
      });
    }
    function K(e, n) {
      ...
      if (e) {
        ...
        var s = e.lang;
        x(i) && (i.indexOf(":") === -1 && (i += ":default"), i = G[i]), x(s) && (s = ka[s]);
      } else
        e = {};
      let r, o, l = e.context || {};
      if (this.encode = e.encode || i && i.encode || ia, this.register = n || v(), this.D = r = e.resolution || 9, this.G = n = i && i.G || e.tokenize || "strict", this.depth = n === "strict" && l.depth, this.l = u(l.bidirectional), this.s = o = u(e.optimize), this.m = u(e.fastupdate), this.B = e.minlength || 1, this.C = e.boost, this.map = o ? aa(r) : v(), this.A = r = l.resolution || 1, this.h = o ? aa(r) : v(), this.F = i && i.F || e.rtl, this.H = (n = e.matcher || s && s.H) && fa(n, !1), this.J = (n = e.stemmer || s && s.J) && fa(n, !0), i = n = e.filter || s && s.filter) {
        i = n, s = v();
    ...
    }, t.add = function(e, n, i, s) {
      if (n && (e || e === 0)) {
        if (!s && !i && this.register[e])
          return this.update(e, n);
        if (n = this.encode(n), s = n.length) {
          const p = v(), m = v(), A = this.depth, w = this.D;
          for (let k = 0; k < s; k++) {
            let g = n[this.F ? s - 1 - k : k];
            var r = g.length;
            if (g && r >= this.B && (A || !m[g])) {
              var o = L(w, s, k), l = "";
              switch (this.G) {
                ...
                default:
                  if (this.C && (o = Math.min(o / this.C(n, g, k) | 0, w - 1)), M(this, m, g, o, e, i), A && 1 < s && k < s - 1) {
                    for (r = v(), l = this.A, o = g, h = Math.min(A + 1, s - k), r[o] = 1, f = 1; f < h; f++)
                      if ((g = n[this.F ? s - 1 - k - f : k + f]) && g.length >= this.B && !r[g]) {
                        r[g] = 1;
                        const y = this.l && g > o;
                        M(this, p, y ? o : g, L(l + (s / 2 > l ? 0 : 1), s, k, h - 1, f - 1), e, i, y ? g : o);
                      }
                  }
              }
            }
    ...
    function L(e, n, i, s, r) {
      return i && 1 < e ? n + (s || 0) <= e ? i + (r || 0) : (e - 1) / (n + (s || 0)) * (i + (r || 0)) + 1 | 0 : 0;
    }
    function M(e, n, i, s, r, o, l) {
      let h = l ? e.h : e.map;
      (!n[i] || l && !n[i][l]) && (e.s && (h = h[s]), l ? (n = n[i] || (n[i] = v()), n[l] = 1, h = h[l] || (h[l] = v())) : n[i] = 1, h = h[i] || (h[i] = []), e.s || (h = h[s] || (h[s] = [])), o && h.includes(r) || (h[h.length] = r, e.m && (e = e.register[r] || (e.register[r] = []), e[e.length] = h)));
    }
    t.search = function(e, n, i) {
      ...
      if (!r)
        return s;
      n || (n = 100), h = this.depth && 1 < r && h !== !1, i = 0;
      let p;
      h ? (p = e[0], i = 1) : 1 < r && e.sort(ba);
      for (let m, A; i < r; i++) {
        if (A = e[i], h ? (m = sa(
          this,
          s,
          ...
          A,
          p
        ), o && m === !1 && s.length || (p = A)) : m = sa(this, s, o, n, l, r === 1, A), m)
          return m;
        if (o && i === r - 1) {
          if (f = s.length, !f) {
            if (h) {
    ...
    function ua(e, n, i, s) {
      return i ? (s = s && n > i, e = (e = e[s ? n : i]) && e[s ? i : n]) : e = e[n], e;
    }
    t.contain = function(e) {
      ...
      if (i) {
        if (this.m)
          for (let s = 0, r; s < i.length; s++)
            r = i[s], r.splice(r.indexOf(e), 1);
        else
          N(this.map, e, this.D, this.s), this.depth && N(this.h, e, this.A, this.s);
        if (n || delete this.register[e], this.cache) {
          n = this.cache;
          for (let s = 0, r, o; s < n.h.length; s++)
            o = n.h[s], r = n.cache[o], r.includes(e) && (n.h.splice(s--, 1), delete n.cache[o]);
        }
      }
      return this;
    };
    function N(e, n, i, s, r) {
      let o = 0;
      if (e.constructor === Array)
        if (r)
          n = e.indexOf(n), n !== -1 ? 1 < e.length && (e.splice(n, 1), o++) : o++;
        else {
          r = Math.min(e.length, i);
          for (let l = 0, h; l < r; l++)
            (h = e[l]) && (o = N(h, n, i, s, r), s || o || delete e[l]);
        }
      else
        for (let l in e)
          (o = N(e[l], n, i, s, r)) || delete e[l];
      return o;
    }
    t.searchCache = oa, t.export = function(e, n, i, s, r) {
      let o, l;
      switch (r || (r = 0)) {
        case 0:
          if (o = "reg", this.m) {
      ...
      return ra(e, n || this, i, o, s, r, l), !0;
    ...
    function va(e) {
      ...
      switch (s) {
        case "init":
          s = e.options || {}, e = e.factory, n = s.encode, s.cache = !1, n && n.indexOf("function") === 0 && (s.encode = Function("return " + n)()), e ? (Function("return " + e)()(self), self._index = new self.FlexSearch.Index(s), delete self.FlexSearch) : self._index = new K(s);
          break;
        default:
          e = e.id, n = n[s].apply(n, i), postMessage(s === "search" ? { id: e, msg: n } : { id: e });
      }
    }
    let wa = 0;
    function O(e) {
      ...
      const i = typeof window > "u" && self.exports, s = this;
      this.o = xa(n, i, e.worker), this.h = v(), this.o && (i ? this.o.on("message", function(r) {
    ...
    function P(e) {
      O.prototype[e] = O.prototype[e + "Async"] = function() {
        ...
        var s = i[i.length - 1];
        let r;
        return D(s) && (r = s, i.splice(i.length - 1, 1)), s = new Promise(function(o) {
          setTimeout(function() {
    ...
    function Q(e) {
      ...
      let s = n.index || n.field || n;
      x(s) && (s = [s]);
      for (let r = 0, o, l; r < s.length; r++)
        o = s[r], x(o) || (l = o, o = o.field), l = C(l) ? Object.assign({}, e, l) : e, this.o && (i[o] = new O(l), i[o].o || (this.o = !1)), this.o || (i[o] = new K(l, this.register)), this.K[r] = S(o, this.A), this.h[r] = o;
      if (this.C)
    ...
    function S(e, n) {
      ...
      let s = 0;
      for (let r = 0; r < i.length; r++)
        e = i[r], 0 <= e.indexOf("[]") && (e = e.substring(0, e.length - 2)) && (n[s] = !0), e && (i[s++] = e);
    ...
    function U(e, n, i, s, r) {
      if (e = e[r], s === i.length - 1)
        n[r] = e;
      else if (e)
        if (e.constructor === Array)
          for (n = n[r] = Array(e.length), r = 0; r < e.length; r++)
            U(e, n, i, s, r);
        else
          n = n[r] || (n[r] = v()), r = i[++s], U(e, n, i, s, r);
    }
    function V(e, n, i, s, r, o, l, h) {
      if (e = e[l])
        if (s === n.length - 1) {
          if (e.constructor === Array) {
            if (i[s]) {
    ...
    t = Q.prototype, t.add = function(e, n, i) {
      if (C(e) && (n = e, e = T(n, this.key)), n && (e || e === 0)) {
        ...
        for (let s = 0, r, o; s < this.h.length; s++)
          o = this.h[s], r = this.K[s], x(r) && (r = [r]), V(n, r, this.A, 0, this.index[o], e, r[0], i);
        if (this.I) {
          let s = T(n, this.I), r = v();
          x(s) && (s = [s]);
          for (let o = 0, l, h; o < s.length; o++)
            if (l = s[o], !r[l] && (r[l] = 1, h = this.l[l] || (this.l[l] = []), !i || !h.includes(e)) && (h[h.length] = e, this.m)) {
        ...
        if (this.store && (!i || !this.store[e])) {
          ...
          if (this.C) {
            ...
            for (let r = 0, o; r < this.C.length; r++)
              o = this.C[r], x(o) ? s[o] = n[o] : U(n, s, o, 0, o[0]);
          }
          this.store[e] = s || n;
        }
      }
      ...
      if (C(e) && (e = T(e, this.key)), this.register[e]) {
        ...
        if (this.I && !this.m)
          for (let i in this.l) {
            n = this.l[i];
            const s = n.indexOf(e);
            s !== -1 && (1 < n.length ? n.splice(s, 1) : delete this.l[i]);
          }
        ...
        if (i.constructor === Array)
          ...
          if (e = i.query || e, f = (l = i.pluck) || i.index || i.field, p = i.tag, h = this.store && i.enrich, m = i.bool === "and", n = i.limit || n || 100, A = i.offset || 0, p && (x(p) && (p = [p]), !e)) {
            for (let g = 0, y; g < p.length; g++)
              (y = ya.call(this, p[g], n, A, h)) && (r[r.length] = y, w++);
            return w ? r : [];
          }
          x(f) && (f = [f]);
        }
      ...
      for (let g = 0, y, j, B; g < f.length; g++) {
        let R;
        if (j = f[g], x(j) || (R = j, j = R.field, e = R.query || e, n = R.limit || n), k)
          k[g] = this.index[j].searchAsync(e, n, R || i);
        else {
          if (s ? y = s[g] : y = this.index[j].search(e, n, R || i), B = y && y.length, p && B) {
            const _ = [];
            let q = 0;
            m && (_[0] = [y]);
            for (let z = 0, H, $; z < p.length; z++)
              H = p[z], (B = ($ = this.l[H]) && $.length) && (q++, _[_.length] = m ? [$] : $);
            q && (y = m ? ma(_, n || 100, A || 0) : na(y, _), B = y.length);
          }
          if (B)
            o[w] = j, r[w++] = y;
          else if (m)
    ...
    function ya(e, n, i, s) {
      let r = this.l[e], o = r && r.length - i;
      if (o && 0 < o)
        return (o > n || i) && (r = r.slice(i, i + n)), s && (r = za.call(this, r)), { tag: e, result: r };
    }
    function za(e) {
      const n = Array(e.length);
      for (let i = 0, s; i < e.length; i++)
        s = e[i], n[i] = { id: s, doc: this.store[s] };
      return n;
    }
    t.contain = function(e) {
      return !!this.register[e];
      ...
      if (r || (r = 0), s || (s = 0), s < this.h.length) {
        ...
        n = this, setTimeout(function() {
          l.export(e, n, r ? o : "", s, r++) || (s++, r = 1, n.export(e, n, o, s, r));
        });
      } else {
        let o, l;
        switch (r) {
        ...
        switch (x(n) && (n = JSON.parse(n)), e) {
          ...
          case "reg":
            ...
            for (let s = 0, r; s < this.h.length; s++)
              r = this.index[this.h[s]], r.register = n, r.m = !1;
            break;
          case "store":
            this.store = n;
            break;
    ...
    function Da(e) {
      ...
      const n = [];
      if (e) {
        const i = e.split(Fa), s = i.length;
        for (let r = 0, o, l = 0; r < s; r++)
          if ((e = i[r]) && (!this.filter || !this.filter[e])) {
            o = e[0];
            let h = Ga[o] || o, f = h;
...
function buildPreviews(e) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    r == "" && (r = s.b), r.length > MAX_PREVIEW_CHARS && (r = r.slice(0, MAX_PREVIEW_CHARS) + " ..."), n[s.id] = {
      t: s.t || s.a,
      p: r,
      l: s.link,
      a: s.a
...
async function IndexSearch(e, n) {
  ...
  const i = await buildDocs(e), s = buildPreviews(i), r = buildIndexSearch(i, n);
  var o = {
    ...
    async load(o) {
      if (o === r)
        return i.build.ssr ? `const INDEX_DATA = { };
				...
				const Options = ${JSON.stringify(n)};
				const data = { INDEX_DATA, PREVIEW_LOOKUP, Options };
				export default data;` : await IndexSearch(i.root, n);
    }
  };
}
export {
