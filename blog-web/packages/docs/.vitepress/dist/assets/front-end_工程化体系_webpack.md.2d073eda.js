...
<span class="line"><span style="color:#A6ACCD;">       mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>然后我们看下打包后的html</p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgvBJ8tCykbOom4uF.png" alt="image-20211107232408194" style="zoom:80%;"><p><code>我们可以发现webpack并不在乎我们编写代码时的资源路径是多少，这个路径只是便于webpack找到对应的资源文件，</code></p><p><code>然后把资源文件复制到配置好的地方，如果我们配置了outputPath则会放置与outputPath，否则直接放在根目录，</code></p><p><code>然后我们引入资源文件的路径也会被改写，从../src/img/angular.jpg变成了img/9a4a32dc0c.jpg</code></p><p>那么output中的publicPath有什么作用呢？</p><p>我们加上publicPath看下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     output: {</span></span>
<span class="line"><span style="color:#A6ACCD;">         filename: &#39;built.js&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">         path: resolve(__dirname, &#39;build&#39;),</span></span>
<span class="line"><span style="color:#A6ACCD;">         publicPath: &#39;/&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">       },</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>再次打包看下</p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgAkU8peSInO1xiYF.png" alt="image-20211107233005925" style="zoom:80%;"><p>原来publicPath就是会在资源路径前缀加上去，/代表了服务器根目录，所以我们必须在服务器把build部署为根路径，否则会报错，</p><p>但是可以省略，或者写成&#39;./&#39;就好了，不过vue-cli的生产模式应该默认就是&#39;/&#39;，我们如果直接以live serve这种插件运行则会报错，因为这个插件的根目录是</p><p>以编译器打开的整个目录为服务器根目录的，所以这时我们可以通过把publicPath设为&#39;./&#39;解决该问题</p><p>详情可以参考：<a href="https://cli.vuejs.org/zh/config/#publicpath" target="_blank" rel="noreferrer">https://cli.vuejs.org/zh/config/#publicpath</a></p><h5 id="打包css-less资源" tabindex="-1">打包css/less资源 <a class="header-anchor" href="#打包css-less资源" aria-hidden="true">#</a></h5><ol><li><p>创建文件</p></li><li><p>下载安装 loader 包</p><p>打包css: npm i css-loader style-loader -D</p><p>打包less: npm i css-loader style-loader less-loader@5.0.0 less -D</p></li><li><p>修改配置文件</p></li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     /*</span></span>
...
<span class="line"><span style="color:#A6ACCD;">     }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li>运行指令: webpack</li></ol><h5 id="打包-html-资源" tabindex="-1">打包 HTML 资源 <a class="header-anchor" href="#打包-html-资源" aria-hidden="true">#</a></h5><ol><li><p>创建文件</p></li><li><p>下载安装 plugin 包</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">npm install --save-dev html-webpack-plugin</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>修改配置文件</p></li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     /*</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>4.运行指令: webpack</p><h5 id="打包图片资源" tabindex="-1">打包图片资源 <a class="header-anchor" href="#打包图片资源" aria-hidden="true">#</a></h5><ol><li><p>创建文件</p></li><li><p>下载安装 loader 包</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">npm install --save-dev html-loader@0.5.5 url-loader file-loader </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>修改配置文件</p></li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">     module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">       entry: &#39;./src/index.js&#39;,</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li>运行指令: webpack</li></ol><p>注：这样能处理html和css中的图片</p><h5 id="打包vue组件" tabindex="-1">打包Vue组件 <a class="header-anchor" href="#打包vue组件" aria-hidden="true">#</a></h5><p>1、初始化项目</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgsmRUvexaQ9DpyNj.png" alt="image-20211114153529618"></p><p>2、安装所需依赖</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	npm i vue-loader vue-template-compiler -D</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>3、在webpack.config.js配置文件中，添加vue-loader的配置项如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const path = require(&#39;path&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       }</span></span>
<span class="line"><span style="color:#A6ACCD;">     }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>运行效果：</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgoz6TLmUlbcNhuZV.png" alt="image-20211114155418398"></p><h5 id="打包其他资源" tabindex="-1">打包其他资源 <a class="header-anchor" href="#打包其他资源" aria-hidden="true">#</a></h5><ol><li>创建文件</li></ol><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210505220422-165685003482948.png" alt="image-20210226142039333" style="zoom:80%;"><ol start="2"><li>修改配置文件</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">     module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">       entry: &#39;./src/index.js&#39;,</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       }</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li>运行指令: npx webpack-dev-server</li></ol><p>webpack-dev-server还有其他很多妙用：比如代理处理跨域、热替换等等</p><p>1、代理处理跨域</p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210326090205-165685003482947.png" alt="image-20210326090205349" style="zoom:67%;"><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     //解决跨域问题</span></span>
<span class="line"><span style="color:#A6ACCD;">       devServer: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">         }</span></span>
<span class="line"><span style="color:#A6ACCD;">       },</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>如果是vue项目，我们应该写在vue.config.js中</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     module.exports = {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       }</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>package.json</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       }</span></span>
<span class="line"><span style="color:#A6ACCD;">     }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>运行指令: npx webpack-dev-server 打包使用webpack</p><h5 id="生产环境" tabindex="-1">生产环境 <a class="header-anchor" href="#生产环境" aria-hidden="true">#</a></h5><h6 id="提取css-less成单独文件" tabindex="-1">提取css/less成单独文件 <a class="header-anchor" href="#提取css-less成单独文件" aria-hidden="true">#</a></h6><ol><li><p>下载安装包</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210302141929-165685142800351.png" alt="image-20210302141928999"></p></li></ol><p>2.下载插件</p><p>​ npm install --save-dev mini-css-extract-plugin</p><ol start="3"><li>修改配置文件</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li><p>修改 package.json</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 做兼容性处理需要在package.json定义该字段，以指示postcss插件如何做兼容性处理</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>或者安装autoprefixer（自动添加前缀插件） npm i autoprefixer</p><p>在根目录新建 <code>postcss.config.js</code> ,并添加如下代码之后，写的css会自动根据Can i use里的数据添加不同前缀了。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">     plugins: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">     }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>如果是vue-cli4，则需要在根目录下配置.browserslistrc，</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">[production staging]</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>postcss.config.js</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">  plugins: {</span></span>
<span class="line"><span style="color:#A6ACCD;">    &#39;autoprefixer&#39;: {},</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>运行指令: webpack</p></li></ol><h6 id="压缩css" tabindex="-1">压缩css <a class="header-anchor" href="#压缩css" aria-hidden="true">#</a></h6><p>1.创建文件</p><p>​ <img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210302152141-165685142800353.png" alt="image-20210302152140533"></p><ol start="2"><li><p>下载安装包</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">npm install --save-dev optimize-css-assets-webpack-plugin </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>运行指令npx webpack</p></li></ol><h6 id="js语法检查" tabindex="-1">js语法检查 <a class="header-anchor" href="#js语法检查" aria-hidden="true">#</a></h6><p>1.创建文件</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210302154538-165685142800352.png" alt="image-20210302154538295"></p><ol start="2"><li>下载安装包</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	npm install --save-dev eslint-loader eslint eslint-config-airbnb-base eslint-plugin-import </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li><p>修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//处理html模板</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//把css从js抽离成单独文件</span></span>
<span class="line"><span style="color:#A6ACCD;">const MiniCssExtractPlugin = require(&#39;mini-css-extract-plugin&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>配置 package.json</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 使用airbnb-base的语法规则，</span></span>
<span class="line"><span style="color:#A6ACCD;">/* </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>或者使用.eslintrc文件（支持JSON和YAML两种语法）</p><p><strong>.eslintrc 文件示例：</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">  &quot;env&quot;: {</span></span>
<span class="line"><span style="color:#A6ACCD;">    &quot;browser&quot;: true,</span></span>
<span class="line"><span style="color:#A6ACCD;">  },</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>eslintrc 放在项目根目录，则会应用到整个项目；如果子目录中也包含 .eslintrc 文件，则子目录会忽略根目录的配置文件，应用该目录中的配置文件。这样可以方便地对不同环境的代码应用不同的规则。</p><p><code>详情请访问：</code><a href="https://www.jianshu.com/p/ad6784d028aa" target="_blank" rel="noreferrer">https://www.jianshu.com/p/ad6784d028aa</a></p><p><strong>在js中忽略某部分js代码语法检查：</strong></p><ol><li><p>关闭段落校验</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">/* eslint-disable */</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>关闭当前行校</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">some code // eslint-disable-line</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>关闭下一行校验</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// eslint-disable-next-line</span></span>
<span class="line"><span style="color:#A6ACCD;">some code</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ol></li><li><p>运行指令: npx webpack</p></li></ol><h6 id="js兼容性处理" tabindex="-1">js兼容性处理 <a class="header-anchor" href="#js兼容性处理" aria-hidden="true">#</a></h6><p>1.创建文件</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/img20210302160842-165685142800354.png" alt="image-20210302160841263"></p><ol start="2"><li>下载安装包</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	npm install --save-dev babel-loader @babel/core @babel/preset-env @babel/polyfill core-js </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li><p>修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//处理html模板</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//把css从js抽离成单独文件</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  mode: &#39;development&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ol><p>4、运行</p><p>​ npx webpack</p><h6 id="js压缩" tabindex="-1">js压缩 <a class="header-anchor" href="#js压缩" aria-hidden="true">#</a></h6><p>1.创建文件</p><p>2、修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     // 生产环境下会自动压缩 js 代码 </span></span>
<span class="line"><span style="color:#A6ACCD;">     mode: &#39;production&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>运行指令: npx webpack</p><h6 id="html压缩" tabindex="-1">html压缩 <a class="header-anchor" href="#html压缩" aria-hidden="true">#</a></h6><p>1.创建文件</p><p>2、修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">  entry: &#39;./src/js/index.js&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">  output: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  mode: &#39;production&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="生产环境配置" tabindex="-1">生产环境配置 <a class="header-anchor" href="#生产环境配置" aria-hidden="true">#</a></h6><p>配置</p><p>webpack.config.js</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//处理html模板</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">//把css从js抽离成单独文件</span></span>
<span class="line"><span style="color:#A6ACCD;">const MiniCssExtractPlugin = require(&#39;mini-css-extract-plugin&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.browerslistrc</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">[production staging]</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt; 1%</span></span>
<span class="line"><span style="color:#A6ACCD;">ie 10</span></span>
<span class="line"><span style="color:#A6ACCD;"> </span></span>
<span class="line"><span style="color:#A6ACCD;">[development]</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  },</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>如果js需要处理的话（暂时还没完全理解）：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     import res from &#39;./src/js/index&#39;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       })</span></span>
<span class="line"><span style="color:#A6ACCD;">     }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="优化代码调试" tabindex="-1">优化代码调试 <a class="header-anchor" href="#优化代码调试" aria-hidden="true">#</a></h6><blockquote><p>source-map：一种提供源代码到构建后代码映射技术（如果代码出错了，通过映射可以追踪源代码错误）</p></blockquote><p>配置:</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>source-map详细介绍：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">/*</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       mode: &#39;production&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="缓存" tabindex="-1"><strong>缓存</strong> <a class="header-anchor" href="#缓存" aria-hidden="true">#</a></h6><blockquote><p>babel缓存： cacheDirectory:true --&gt;让第二次打包构建速度更快 文件资源缓存： hash:每次webpack构建时会生成一个唯一的hash值 问题：因为js和css使用同一个hash值，如果重新打包会导致所有的缓存失效（可能我只改动了一个文件） chunkhash:根据chunk生成的hash值。如果打包来源于同一个chunk,name hash值就一样。 问题：可能js和css还是一样的，因为css在js中被引入的，同属于一个chunk。（所以根据入口文件引入的文件都会生成一个chunk) contenthash（推荐）:根据文件内容生成hash值，不同文件不一样 --&gt;让代码上线运行缓存更好使用</p></blockquote><p>1 创建文件</p><p>​ <img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgnE2w3sumjX6QLyi.png" alt="image-20211101200236915"></p><ol start="2"><li><p>修改配置文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">const MiniCssExtractPlugin = require(&#39;mini-css-extract-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">const OptimizeCssAssetsWebpackPlugin = require(&#39;optimize-css-assets-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">  mode: &#39;production&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ol><h6 id="多进程打包" tabindex="-1">多进程打包 <a class="header-anchor" href="#多进程打包" aria-hidden="true">#</a></h6><blockquote><p>开启多进程打包，提升打包速度，但是开启进程需要一定时间，如果是比较小的项目，使开启多进程打包反而会适得其反</p></blockquote><p>安装依赖</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     npm i thread-loader -D</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>使用：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const MiniCssExtractPlugin = require(&#39;mini-css-extract-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const OptimizeCssAssetsWebpackPlugin = require(&#39;optimize-css-assets-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>jquery的使用如下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	// 我们不想这么用</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>这时，我们便需要配置externals</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">     module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">       entry: &#39;./src/js/index.js&#39;,</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       }</span></span>
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>我们可以看看编译后的文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     ({</span></span>
...
<span class="line"><span style="color:#A6ACCD;">          /* ... */</span></span>
<span class="line"><span style="color:#A6ACCD;">     });</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>但是，我们还是得在html手动引入Cdn的</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     &lt;!DOCTYPE html&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="dll" tabindex="-1">dll <a class="header-anchor" href="#dll" aria-hidden="true">#</a></h6><blockquote><p>使用dll技术，对某些库（第三方库：jquery、react、vue...）进行单独打包</p><p>也就是让webpack这个命令不打包某些库，让我们手动通过webpack --config webpack.dll.js更新</p></blockquote><p>安装依赖库</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	npm i add-asset-html-webpack-plugin -D</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>配置：</p><p>webpack.dll.js:</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     /*</span></span>
...
<span class="line"><span style="color:#A6ACCD;">         </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><p>任何导入的文件都会收到tree shaking的影响，所以一些导入时会执行特殊行为的代码，它们不是仅仅暴露一个export或多个export（<strong>副作用</strong>），比如polyfill，就会被tree shaking给删除。另外，css文件，也会因为这种原因被tree shaking删除。</p><p>为了避免这种无意的删除，就需要在package.json中对sideEffects选项进行设置：</p><p>package.json:</p><div class="language-json"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><p>现在全部设置完毕，进行打包：</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgv2-b21fad4dfc17ec91b73aaf041b13ff67_720w.jpg" alt="img"></p><p>再次打开main.js，可以发现tree shaking就生效了：</p><p><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgv2-d34b226cd2a5f34d75c5c875c310289f_720w.jpg" alt="img"></p><p>但是开发模式下并不会把没用的代码删掉，因为如果删掉的话回导致调试困难，比如source map提示的行数不对应等。</p><p><strong>二、在生产模式下开启tree shaking</strong></p><p>在生产模式下就不要optimization选项进行设置了，因为webpack会在生产模式下默认打开tree shaking。</p><p>所以把webpack.config.js修改成：</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> path </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">require</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">path</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="pwa" tabindex="-1">pwa <a class="header-anchor" href="#pwa" aria-hidden="true">#</a></h6><blockquote><p>PWA: 渐进式网络开发应用程序（离线可访问）</p><p>​ workbox --&gt; workbox-webpack-plugin</p><p>在webpack中通过workbox插件实现，也就是 workbox-webpack-plugin</p></blockquote><p>安装依赖：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">      npm i workbox-webpack-plugin</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>使用：</p><p>webpack.config.js</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const { resolve } = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const MiniCssExtractPlugin = require(&#39;mini-css-extract-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const OptimizeCssAssetsWebpackPlugin = require(&#39;optimize-css-assets-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const HtmlWebpackPlugin = require(&#39;html-webpack-plugin&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const WorkboxWebpackPlugin = require(&#39;workbox-webpack-plugin&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">     };</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>在入口Js中注册service-worker</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     import { mul } from &#39;./test&#39;;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">          }</span></span>
<span class="line"><span style="color:#A6ACCD;">      }      </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>2.在public/index.html文件配置 使用 webpack中自带的插件 html插件进行配置，在 index.html 中增加判断，是否使用 CDN， htmlWebpackPlugin.options 使用的是vue.config中的config.plugin(&#39;html&#39;)的插件属性。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">    &lt;!-- 使用CDN的CSS文件 --&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>四、nginx开启gzip功能</p><p>​ 当gzip文件已经生成了，我们只需要在nginx下配置以下一句即可：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">gzip_static on;   // 其中gzip_static on这个属性是静态加载本地的gz文件。</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><img src="https://webpon-img.oss-cn-guangzhou.aliyuncs.com/imgimage-20220704223708226.png" alt="image-20220704223708226" style="zoom:67%;"><p><strong>需要注意的问题：</strong></p><ul><li><p>优化是对资源分配的平衡，压缩需要cpu来参与计算，所以开启压缩是需要与cpu开销问题一起来综合考虑。不能一味追求高压缩比。比如当文件很大时，压缩文件会带来明显延迟，系统CPU也会产生瞬间冲上去。</p></li><li><p><code>html、js、json、css</code>等，开启压缩，会给网站带来明显的优化效果。 而针对大文件的情况，要么事先手工压缩好，要通过其它方式提供服务，不建议在<code>nginx</code>中开启对大文件的压缩。</p></li></ul><p><strong>当然，我们也可以采用服务器进行gzip压缩</strong></p><p>浏览器请求xx.js文件时，服务器对xx.js文件进行gzip压缩后传输给浏览器</p><p>前端不用进行任何配置，也不用webpack生成gz文件，服务器进行处理，拿nginx举例：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">http {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="按需引入" tabindex="-1">按需引入 <a class="header-anchor" href="#按需引入" aria-hidden="true">#</a></h6><h5 id="webpack配置详解" tabindex="-1">webpack配置详解 <a class="header-anchor" href="#webpack配置详解" aria-hidden="true">#</a></h5><h5 id="不同环境不同配置" tabindex="-1">不同环境不同配置 <a class="header-anchor" href="#不同环境不同配置" aria-hidden="true">#</a></h5><blockquote><p>实际项目中，往往不同环境有不同的构建需求。比如开发、测试和生产环境对应的后端接口地址不同，生产环境需要进行代码混淆、压缩等。</p><p>因此，往往还需要将webpack配置分成多个</p></blockquote><p>安装webpack-merge，用于合并配置：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     npm install webpack-merge --save-dev</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>拆分webpack.config.js为以下几个配置：</p><p>基础配置 webpack.base.config.js：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">     const path = require(&#39;path&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">     const webpack = require(&#39;webpack&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
