...
// new Promise(res => {
//     res(1)
// }).then(res => { console.log(res); return new Promise(res => res(3)) }).then(res => console.log(res))
// console.log(Promise.resolve(12));
...
// Promise.resolve(thenable).then(res => console.log(res)) //这会造成一个死循环
